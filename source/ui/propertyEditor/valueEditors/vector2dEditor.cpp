    ...
    , m_yLineEdit(new ValueEntryLineEdit(this))
{
    ...
    connect(
        ...
        this,
        &AbstractVector2DWidget::onValueEntryChanged);
    connect(
        m_yLineEdit,
        &ValueEntryLineEdit::valueChanged,
        this,
    ...
    const QColor&       backgroundColor)
{
    ...
    label->setStyleSheet(
        QString("background-color: %1; color: white; padding: 2px; border-top-left-radius: 2px; "
...
template <typename T>
Vector2DEditor<T>::Vector2DEditor(
    const QString&         name,
    const Vector2dData<T>& data,
